...
def turn_on_virtual_input(virtual_input_id):
    client.unit_id(13)
    client.write_single_coil(virtual_input_id, 1)


def turn_off_virtual_input(virtual_input_id):
    client.unit_id(13)
    client.write_single_coil(virtual_input_id, 0)
...
# turn_on_virtual_input(15)
# sleep(1.2)
# turn_off_virtual_input(15)
